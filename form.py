...
"color: rgb(0, 0, 0);")
        ...
        self.label_5.setMinimumSize(QtCore.QSize(245, 30))
        self.label_5.setMaximumSize(QtCore.QSize(245, 30))
        self.label_5.setObjectName("label_5")
        self.horizontalLayout_6.addWidget(self.label_5)
        self.comboBox = QtWidgets.QComboBox(self.frame_8)
        self.comboBox.setMinimumSize(QtCore.QSize(241, 30))
        self.comboBox.setMaximumSize(QtCore.QSize(241, 30))
...
"")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_5.setText(_translate("MainWindow", "Шифрование и ключ:"))
        self.comboBox.setItemText(0, _translate("MainWindow", "Ничего"))
        self.comboBox.setItemText(1, _translate("MainWindow", "Цезарь"))
        self.comboBox.setItemText(2, _translate("MainWindow", "Вижинер"))
        self.comboBox.setItemText(3, _translate("MainWindow", "XOR"))
        self.comboBox.setItemText(4, _translate("MainWindow", "Backbone"))
        self.lineEdit.setPlaceholderText(_translate("MainWindow", "Введите ключ"))
